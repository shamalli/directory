...
class __TwigTemplate_c874b8ed71533e1a3d504c85a7422d9f1b56ad4c2d87cf2131aab2a075d546f1 extends Twig_Template
{
    ...
    <form id=\"wpml-media-dialog-form\" method=\"post\" enctype=\"multipart/form-data\">
        ...
        // line 12
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "original", array()), "html", null, true);
        echo "<span class=\"wpml-title-flag\"><img
                            src=\"#\"></span><strong>%from_language%</strong>
            </h3>
            <h3 class=\"wpml-header-translation\">";
        // line 15
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "translation", array()), "html", null, true);
        echo "<span class=\"wpml-title-flag\"><img
        ...
        <div class=\"wpml-form-row\">
            ...
            <label>";
        // line 23
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "file", array()), "html", null, true);
        echo "</label>
        ...
        // line 36
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "use_different_file", array()), "html", null, true);
        echo "</span>
                </a>
        ...
        // line 40
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "revert_to_original", array()), "html", null, true);
        echo "</a>
                </span>
            </span>
        ...
        // line 47
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "name", array()), "html", null, true);
        echo "</label>
            ...
            <button class=\"button-copy button-secondary js-button-copy otgs-ico-copy\"
                    title=\"";
        // line 50
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "copy_from_original", array()), "html", null, true);
        echo "\"></button>
        ...
        // line 54
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "caption", array()), "html", null, true);
        echo "</label>
        ...
        // line 61
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "alt_text", array()), "html", null, true);
        echo "</label>
    ...
    ";
        ...
        <p>";
            // line 77
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "texts_change_notice", array()), "html", null, true);
            echo "</p>
    </div>
    ";
        }
...
";
    ...
    {
        return new Twig_Source("<div id=\"wpml-media-dialog\">
    <span class=\"ajax-loader\"></span>
    <form id=\"wpml-media-dialog-form\" method=\"post\" enctype=\"multipart/form-data\">
        {{ nonce|raw }}
        <input type=\"hidden\" name=\"original-attachment-id\" value=\"\"/>
...
", "media-translation-popup.twig", "C:\\xampp\\htdocs\\wp\\wp-content\\plugins\\wpml-media-translation\\templates\\menus\\media-translation-popup.twig");
    }
}
