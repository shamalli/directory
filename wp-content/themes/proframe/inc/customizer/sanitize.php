 ...
 */
function proframe_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function proframe_sanitize_css( $css ) {
 ...
 */
function proframe_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function proframe_sanitize_email( $email, $setting ) {
 ...
 */
function proframe_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function proframe_sanitize_html( $html ) {
 ...
 */
function proframe_sanitize_image( $image, $setting ) {
 ...
 */
function proframe_sanitize_nohtml( $nohtml ) {
 ...
 */
function proframe_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function proframe_sanitize_number_range( $number, $setting ) {
 ...
 */
function proframe_sanitize_select( $input, $setting ) {
 ...
 */
function proframe_sanitize_url( $url ) {
