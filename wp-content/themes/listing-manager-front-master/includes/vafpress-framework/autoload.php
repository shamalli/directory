...
*/
VP_W2THEME_AutoLoader::add_namespaces(VP_W2THEME_NAMESPACE);
VP_W2THEME_AutoLoader::add_directories(VP_W2THEME_CLASSES_DIR, VP_W2THEME_NAMESPACE);
VP_W2THEME_AutoLoader::register();

class VP_W2THEME_AutoLoader
{

	/**
	 * Indicates if VP_W2THEME_AutoLoader has been registered.
	 * 
	 * @var boolean
	 */
	...
	public static function register()
	{
		...
		{
			spl_autoload_register(array('VP_W2THEME_AutoLoader', 'load'));
		}
