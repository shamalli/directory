 ...
 */
abstract class VP_W2THEME_Control_Field implements iFactory
{
	...
	protected function _setup_data()
	{
		...
		$this->add_data('head_info', array(
			...
			'description'             => VP_W2THEME_Util_Text::parse_md($this->get_description())
		));
	}
	 ...
	 * @return VP_W2THEME_Control_Field Field object
	 */
