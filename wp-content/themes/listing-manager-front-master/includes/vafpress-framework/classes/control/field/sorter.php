...
class VP_W2THEME_Control_Field_Sorter extends VP_W2THEME_Control_FieldMulti implements VP_W2THEME_MultiSelectable
{
	...
	protected function _setup_data()
	{
		...
		$this->add_data('opt', VP_W2THEME_Util_Text::make_opt($opt));
	...
	public function render($is_compact = false)
	{
		...
		return VP_W2THEME_View::instance()->load('control/sorter', $this->get_data());
	}
