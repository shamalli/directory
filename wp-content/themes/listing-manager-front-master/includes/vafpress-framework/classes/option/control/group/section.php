...
class VP_W2THEME_Option_Control_Group_Section extends VP_W2THEME_Option_Control_Group
{
	...
	public function render($extra = array())
	{
		...
		return VP_W2THEME_View::instance()->load('option/section', $this->get_data());
	}
