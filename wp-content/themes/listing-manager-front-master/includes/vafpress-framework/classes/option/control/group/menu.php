...
class VP_W2THEME_Option_Control_Group_Menu extends VP_W2THEME_Option_Control_Group
{

	/**
	 * Collection of $_menu
	 * @var VP_W2THEME_Option_Control_Group
	 */	
	private $_menus;

	/**
	 * Collection of controls
	 * @var VP_W2THEME_Control_Field
	 */	
	private $_controls;
	...
	public function render($extra = array())
	{
		...
		return VP_W2THEME_View::instance()->load('option/menu', $this->get_data());
	}
