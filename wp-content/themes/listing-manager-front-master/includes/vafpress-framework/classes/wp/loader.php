...
class VP_W2THEME_WP_Loader
{
	...
	{
		$this->_dependencies = apply_filters( 'vp_w2theme_dependencies_array', VP_W2THEME_Util_Config::instance()->load('dependencies') );
		$this->_types        = array(
			'option'             => array(),
			'metabox'            => array(),
	...
	public function build()
	{
		...
		// register and add w2theme_shared-js at the end of dependencies
		$this->js_unit_register('w2theme_shared', $req_scripts);
		...
		do_action( 'vp_w2theme_after_dependencies_loader_build' );
	...
	{
		$messages = VP_W2THEME_Util_Config::instance()->load('messages');
		$localize = array(
			'use_upload'               => $this->_use_media_upload,
			'use_new_media_upload'     => $this->_use_wp_35_media_upload,
			'public_url'               => VP_W2THEME_PUBLIC_URL,
			...
			// validatable data
			'alphabet_validatable'     => apply_filters( 'vp_w2theme_alphabet_validatable'    , array( 'vp-textbox', 'vp-textarea' ) ),
			'alphanumeric_validatable' => apply_filters( 'vp_w2theme_alphanumeric_validatable', array( 'vp-textbox', 'vp-textarea' ) ),
			'numeric_validatable'      => apply_filters( 'vp_w2theme_numeric_validatable'     , array( 'vp-textbox', 'vp-textarea' ) ),
			'email_validatable'        => apply_filters( 'vp_w2theme_email_validatable'       , array( 'vp-textbox', 'vp-textarea' ) ),
			'url_validatable'          => apply_filters( 'vp_w2theme_url_validatable'         , array( 'vp-textbox', 'vp-textarea' ) ),
			'maxlength_validatable'    => apply_filters( 'vp_w2theme_maxlength_validatable'   , array( 'vp-toggle', 'vp-radiobutton', 'vp-radioimage', 'vp-select' ) ),
			'minlength_validatable'    => apply_filters( 'vp_w2theme_minlength_validatable'   , array( 'vp-toggle', 'vp-radiobutton', 'vp-radioimage', 'vp-select' ) ),
		);
