...
class Upload_List extends Field {
	...
	public function render_control() {
        ...
        <div class="xts-upload-btns">
            <button class="xts-btn xts-upload-btn"><?php esc_html_e( 'Upload', 'basel' ); ?></button>
            <button class="xts-btn xts-clear-all xts-remove-upload-btn"><?php esc_html_e( 'Clear all', 'basel' ); ?></button>
