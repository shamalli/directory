	...
	public function render_control() {
		...
		?>
			<div id="<?php echo esc_attr( $this->get_id() ); ?>" data-id="<?php echo esc_attr( $this->get_id() ); ?>" data-key="<?php echo esc_attr( $key ); ?>" class="xts-custom-fonts">
				...
				<div class="xts-custom-fonts-btn-add xts-inline-btn xts-inline-btn-add"><?php esc_html_e( 'Add font', 'basel' ); ?></div>
			...
			<div class="xts-custom-fonts-section<?php echo esc_attr( $hide_class ); ?>" data-id="<?php echo esc_attr( $this->get_id() ); ?>-<?php echo esc_attr( $index ); ?>">
				...
				<div class="xts-custom-fonts-field">
					<h4 class="xts-custom-fonts-label">
						<?php esc_html_e( 'Font name', 'basel' ); ?>
					</h4>
					...
					<p><?php esc_html_e( 'Enter your name with letters and spacing only. It will be used in a list of fonts under the Typography section. For example: Indie Flower', 'basel' ); ?></p>
				</div>
				...
				<?php foreach ( $this->args['fonts'] as $font ) : ?>
					<?php
						...
						$title  = sprintf( __( 'Font (.%s)', 'basel' ), esc_attr( $font ) );
				...
				<div class="xts-custom-fonts-btn-remove xts-inline-btn xts-inline-btn-remove"><?php esc_html_e( 'Remove', 'basel' ); ?></div>
		...
		?>
			<div class="xts-custom-fonts-field xts-upload-control">
				...
				<div class="xts-upload-btns">
					...
					<button class="xts-btn xts-remove-upload-btn<?php echo ( isset( $url ) && ! empty( $url ) ) ? ' xts-btn-shown' : ''; ?>"><?php esc_html_e( 'Remove', 'xts-theme' ); ?></button>
