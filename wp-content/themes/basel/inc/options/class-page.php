...
class Page extends Singleton {
	...
	public function init() {
		...
		if ( current_user_can( apply_filters( 'basel_dashboard_theme_links_access', 'administrator' ) ) ) {
	...
	public function admin_bar_links( $admin_bar ) {
		$admin_bar->add_node(
			array(
				'id'    => 'theme-dashboard',
				'title' => esc_html__( 'Theme Settings', 'basel' ),
			...
			<div class="wrap">	
				<div class="xts-page">
					<div class="xts-page-inner">
						<div class="xts-options xts-dashboard">
								...
								<div class="xts-options-header">
									<div class="xts-options-theme-data">
										...
										<span class="xts-options-theme-version">
											<?php echo esc_html( basel_get_theme_info( 'Version' ) ); ?>
										</span>
									</div>
									<div class="xts-options-search">
										<input type="text" placeholder="<?php esc_html_e( 'Start typing to find options...', 'basel' ); ?>">
									</div>
								</div>
									...
									<div class="xts-fields-tabs">
										...
										<div class="xts-sections">
											...
											<div class="xts-options-actions">
												...
												<button class="xts-save-options-btn xts-btn xts-btn-primary"><?php esc_html_e( 'Save options', 'xts-theme' ); ?></button>
												<button class="xts-reset-options-btn xts-btn" name="xts-<?php echo esc_attr( $this->opt_name ); ?>-options[reset-defaults]" value="1"><?php esc_html_e( 'Reset defaults', 'xts-theme' ); ?></button>
											</div>
										</div>
									</div>
