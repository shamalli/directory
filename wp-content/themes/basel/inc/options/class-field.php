...
abstract class Field {
	 ...
	 * @param object $object   Object for post or term.
	 */
	 ...
	 * @param  int    $preset Current field preset ID.
	 */
	 ...
	 * @since 1.0.0
	 *
	 * @param  string $subkey Subkey for array fields.
	 * @param  string $subkey2 Subkey for array fields. Second level.
	 * @param  string $subkey3 Subkey for array fields. Third level.
	...
	public function get_field_value( $subkey = false ) {
		...
		if ( 'metabox' === $this->_type && empty( $val ) ) {
	 ...
	 * @since 1.0.0
	 *
	 * @param  string $value Feild value string.
	 * @return boolean       Sanitization result.
	 */
