<?php
/**
 * basel WooCommerce Adjacent Products Class
 *
 * @since    2.4.3
 * @package  xts
 */
...
if ( ! class_exists( 'WC_Adjacent_Products' ) ) :
	/**
	 * The basel WooCommerce Adjacent Products Class
	 */
	class WC_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'basel_woocommerce_adjacent_query_args', $args ) );
