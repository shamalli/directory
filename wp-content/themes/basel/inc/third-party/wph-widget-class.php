    ...
    class WPH_Widget extends WP_Widget
    {
        ...
        */
        ...
        function create_field( $key, $out = "" ) {
            ...
            $slug = (isset($key['id'])) ? $key['id'] : $key['param_name'];
            $key['name'] = (isset($key['name'])) ? $key['name'] : $key['heading'];
            ...
            $key['type'] = $this->basel_change_type($key['type']);
        ...
        private function basel_change_type($key) {
            switch ($key) {
                case 'textfield':
                    $key = 'text';
                break;
        ...
        */
        ...
        function create_field_attach_image( $key, $out = "" )
        {
            ...
            $out .= '<img src="'.$url.'" class="basel-image-src" style="'.$style.'" />';

            $out .= '<input type="hidden" ';

            if ( isset( $key['class'] ) )
                $out .= 'class="basel-image-upload ' . esc_attr( $key['class'] ) . '" ';
            ...
            $out .= '<button class="button basel-image-upload-btn">' .esc_html__('Upload image', 'basel') . '</button>';
