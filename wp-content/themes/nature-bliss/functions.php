...
if ( ! function_exists( 'nature_bliss_setup' ) ) :
	...
	function nature_bliss_setup() {
		...
		load_theme_textdomain( 'nature-bliss', get_template_directory() . '/languages' );
...
function nature_bliss_scripts() {
	...
	wp_enqueue_style( 'nature-bliss-style', get_stylesheet_uri(), null, date( 'Ymd-Gis', filemtime( get_template_directory() . '/style.css' ) ) );
	...
	wp_enqueue_script( 'nature-bliss-custom', get_template_directory_uri() . '/js/custom' . $min . '.js', array( 'jquery' ), '1.0.4', true );
