...
if ( ! function_exists( 'nature_bliss_footer_copyright' ) ) :
	...
	function nature_bliss_footer_copyright() {
		...
		// Powered by content.
		$powered_by_text = sprintf( esc_html__( 'Nature Bliss by %s', 'nature-bliss' ), '<a target="_blank" rel="designer" href="https://wenthemes.com/">' . esc_html__( 'WEN Themes', 'nature-bliss' ) . '</a>' );
