...
if ( ! function_exists( 'nature_bliss_the_excerpt' ) ) :
	 ...
	 */
	function nature_bliss_the_excerpt( $length = 40, $post_obj = null ) {
...
if ( ! function_exists( 'nature_bliss_simple_breadcrumb' ) ) :
	 ...
	 * @since 1.0.0
	 */
	function nature_bliss_simple_breadcrumb() {
...
if ( ! function_exists( 'nature_bliss_fonts_url' ) ) :
	 ...
	 */
	function nature_bliss_fonts_url() {
		...
		if ( 'off' !== _x( 'on', 'Roboto font: on or off', 'nature-bliss' ) ) {
			$fonts[] = 'Roboto:300,300i,400,400i,500,500i,700,700i';
		}

		/* translators: If there are characters in your language that are not supported by Montserrat, translate this to 'off'. Do not translate into your own language. */
		if ( 'off' !== _x( 'on', 'Montserrat font: on or off', 'nature-bliss' ) ) {
...
if( ! function_exists( 'nature_bliss_primary_navigation_fallback' ) ) :
	 ...
	 * @since 1.0.0
	 */
	function nature_bliss_primary_navigation_fallback() {
		echo '<ul>';
		echo '<li><a href="' . esc_url( home_url( '/' ) ) . '">' . __( 'Home', 'nature-bliss' ) . '</a></li>';
		wp_list_pages( array(
			'title_li' => '',
			'depth'    => 1,
			'number'   => 8,
...
if ( ! function_exists( 'nature_bliss_the_custom_logo' ) ) :
	 ...
	 * @since 2.0
	 */
	function nature_bliss_the_custom_logo() {
