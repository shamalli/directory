...
<body <?php body_class(); ?>>
	...
	<div class="page-header" <?php if ($image_url = wdt_get_page_featured_image()) echo 'style="background-image: url(' . $image_url . ');"' ?>>
		...
		<?php wdt_print_breadcrumbs(); ?>
		
		<div class="container">
			<img class="wdt-curved-arrow-img" src="<?php echo get_stylesheet_directory_uri() . "/curved_arrow_label.png"; ?>" /><img class="wdt-curved-arrow-img" src="<?php echo get_stylesheet_directory_uri() . "/curved_arrow.png"; ?>" />
		</div>
	</div>
	<?php endif; ?>
	
	<?php do_action("wdt_after_header"); ?>
