...
{
    const VERSION = '1.3.29', PACKAGE = 'sabai-directory';
    ...
    public function onSabaiRunCron($lastRunTimestamp, $logs)
    {
        ...
        foreach ($listings as $listing) {
            ...
            $tags = array(
                ...
                '{listing_renew_url}' => $this->_application->MainUrl('/' . $this->_application->getAddon('Directory')->getSlug('dashboard') . '/renew-listing', array('listing_id' => $listing->getId())),
            );
    ...
    public function onFormBuildFielduiAdminEditField(&$form, &$storage)
    {
        ...
        $directory_category_default = empty($_POST['directory_category']) ? $form['#field']->getFieldData('directory_category') : $_POST['directory_category'];
        $this->_onFormBuildFielduiAdminField($form, $storage, $form['#field']->isCustomField(), $directory_category_default, $add_directory_unclaimed, $directory_unclaimed_default);
    }
