                    ...
                    switch ($this->_settings['address_type'] = $context->getRequest()->asStr('address_type', $this->_settings['address_type'])) {
                        ...
                        default:
                            ...
                            if (!$this->_center || empty($this->_settings['distance'])) { 
                                $geocode = $this->GoogleMaps_Geocode($this->_settings['address'], false, empty($this->_settings['search']['country']) ? array() : array('components' => 'country:' . $this->_settings['search']['country']));
