...
class W2RR_VP_Option_Depsloader
{

	/**
	 * The W2RR_VP_Option_Set object!
	 */
	private $things;
	...
	public function build()
	{
		...
		$result['scripts'] = W2RR_VP_Util_Config::instance()->load('dependencies', 'scripts.always');
		$result['styles']  = W2RR_VP_Util_Config::instance()->load('dependencies', 'styles.always');

		$scripts = W2RR_VP_Util_Config::instance()->load('dependencies', 'scripts.paths');
		$styles  = W2RR_VP_Util_Config::instance()->load('dependencies', 'styles.paths');
	...
	public function can_output($hook_suffix = '')
	{
		...
		$menu_page_slug = W2RR_VP_Util_Config::instance()->load('option', 'menu_page_slug');
