...
class VP_W2RR_Option_Depsloader
{

	/**
	 * The VP_W2RR_Option_Set object!
	 */
	private $things;
	...
	public function build()
	{
		...
		$result['scripts'] = VP_W2RR_Util_Config::instance()->load('dependencies', 'scripts.always');
		$result['styles']  = VP_W2RR_Util_Config::instance()->load('dependencies', 'styles.always');

		$scripts = VP_W2RR_Util_Config::instance()->load('dependencies', 'scripts.paths');
		$styles  = VP_W2RR_Util_Config::instance()->load('dependencies', 'styles.paths');
	...
	public function can_output($hook_suffix = '')
	{
		...
		$menu_page_slug = VP_W2RR_Util_Config::instance()->load('option', 'menu_page_slug');
