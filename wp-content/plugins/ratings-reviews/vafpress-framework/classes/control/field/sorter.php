...
class VP_W2RR_Control_Field_Sorter extends VP_W2RR_Control_FieldMulti implements VP_W2RR_MultiSelectable
{
	...
	public function render($is_compact = false)
	{
		...
		return VP_W2RR_View::instance()->load('control/sorter', $this->get_data());
	}
