...
class W2RR_VP_Control_Field_Sorter extends W2RR_VP_Control_FieldMulti implements W2RR_VP_MultiSelectable
{
	...
	public function render($is_compact = false)
	{
		...
		return W2RR_VP_View::instance()->load('control/sorter', $this->get_data());
	}
