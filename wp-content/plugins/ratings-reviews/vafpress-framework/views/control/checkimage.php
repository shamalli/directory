...
<label>
	...
	<img src="<?php echo VP_W2RR_Util_Res::img($item->img); ?>" alt="<?php echo $item->label; ?>" class="vp-js-tipsy image-item" style="<?php VP_W2RR_Util_Text::print_if_exists($item_max_width, 'max-width: %spx; '); ?><?php VP_W2RR_Util_Text::print_if_exists($item_max_height, 'max-height: %spx; '); ?>" original-title="<?php echo $item->label; ?>" />
</label>
<?php endforeach; ?>
