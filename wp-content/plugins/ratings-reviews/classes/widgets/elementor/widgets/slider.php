...
class w2rr_slider_elementor_widget extends w2rr_elementor_widget {
	...
	protected function register_controls() {
		...
		$controls = w2rr_elementor_convert_params($w2rr_slider_widget_params);
	...
	protected function render() {
		...
		$w2rr_instance->frontend_controllers['webrr-slider'][] = $controller;
