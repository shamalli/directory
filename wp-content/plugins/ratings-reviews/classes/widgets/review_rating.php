...
add_action('init', function() {
	...
	$w2rr_review_rating_widget_params = array(
			array(
					'type' => 'textfield',
					'param_name' => 'review',
...
class w2rr_review_rating_widget extends w2rr_widget {

	public function __construct() {
		global $w2rr_instance, $w2rr_review_rating_widget_params;

		parent::__construct(
				'w2rr_review_rating_shortcode_widget',
				esc_html__('Review rating', 'w2rr')
		);

		$this->convertParams($w2rr_review_rating_widget_params);
	}
	...
	public function render_widget($instance, $args) {
		...
		if ($controller->query->have_posts()) {
			...
			echo '<div class="w2rr-content w2rr-widget w2rr-review-rating-widget">';
