...
class w2rr_updater {
	...
	public function support_checker_response($date) {
		...
		if ($date > time()) {
			return '<p class="w2rr-license-support-checker-active">' . esc_html__("Your support is active till ", "W2RR") . date_i18n(get_option('date_format'), intval($date)) . '. ' . esc_html__("Please follow the link if you wish", "W2RR") . ' ' . '<a href="' . w2rr_getUpdateSupportLink() . '" target="_blank">' . esc_html__("to renew", "W2RR") . '</a></p>';
		} else {
			return '<p class="w2rr-license-support-checker-expired">' . esc_html__("Your support has expired since ", "W2RR") . date_i18n(get_option('date_format'), intval($date)) . '. ' . esc_html__("Please follow the link", "W2RR") . ' ' . '<a href="' . w2rr_getUpdateSupportLink() . '" target="_blank">' . esc_html__("to renew", "W2RR") . '</a></p>';
		}
	}
