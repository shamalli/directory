...
add_action('init', 'w2rr_register_error_messages');
function w2rr_register_error_messages() {
 ...
 * @category	Validation
 * @author		ExpressionEngine Dev Team
 * @link		http://codeigniter.com/user_guide/libraries/w2rr_form_validation.html
 */
class w2rr_form_validation {
	...
	function result_array($field_name = null)
	{
		if (!$field_name) {
			...
			{
				$result[$field] = stripslashes_deep($value['postdata']);
			}
			return $result;
		} else
			return stripslashes_deep($this->_field_data[$field_name]['postdata']);
	}
...
/* End of file w2rr_form_validation.php */
/* Location: ./system/libraries/w2rr_form_validation.php */
