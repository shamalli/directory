...
class w2rr_post {
	...
	public function title() {
		...
		$title = apply_filters('w2rr_post_title', $title, $this);
	...
	public function url() {
		...
		$permalink = apply_filters('w2rr_post_url', $permalink, $this);
	...
	public function getExcerptFromContent($words_length = 35) {
		...
		$the_excerpt = apply_filters('w2rr_get_excerpt_from_content', $the_excerpt, $words_length, $this);
	...
	public function increaseClicksStats() {
		...
		do_action('w2rr_increase_click_stats', $this);
	}
}
