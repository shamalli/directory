	...
	<form action="<?php echo w2rr_get_add_review_link($target_post->post->ID); ?>" method="POST" enctype="multipart/form-data">
		...
		<div class="w2rr-submit-section w2rr-submit-section-contact-info">
			...
			<div class="w2rr-submit-section-inside">
				...
				<input type="text" name="w2rr_user_contact_name" value="<?php echo esc_attr($frontend_controller->w2rr_user_contact_name); ?>" class="w2rr-form-control" style="width: 100%;" />
				...
				<input type="text" name="w2rr_user_contact_email" value="<?php echo esc_attr($frontend_controller->w2rr_user_contact_email); ?>" class="w2rr-form-control" style="width: 100%;" />
