...
abstract class Sabai_Addon_PaidListings_Model_Base_OrderItem extends SabaiFramework_Model_Entity
{
    public function __construct(SabaiFramework_Model $model)
    {
        ...
        $this->_vars = array('orderitem_status' => 0, 'orderitem_feature_name' => null, 'orderitem_id' => 0, 'orderitem_created' => 0, 'orderitem_updated' => 0, 'orderitem_order_id' => 0);
    }
    ...
    public function __set($name, $value)
    {
        ...
        elseif ($name === 'feature_name')
            $this->_setVar('orderitem_feature_name', $value);
        elseif ($name === 'id')
