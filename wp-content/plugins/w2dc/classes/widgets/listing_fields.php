...
add_action('init', function() {
	...
	$w2dc_listing_fields_widget_params = array(
			array(
					'type' => 'textfield',
					'param_name' => 'listing',
...
class w2dc_listing_fields_widget extends w2dc_widget {

	public function __construct() {
		global $w2dc_instance, $w2dc_listing_fields_widget_params;

		parent::__construct(
				'w2dc_listing_fields_shortcode_widget',
				esc_html__('Directory widget - Listing fields', 'w2dc')
		);

		$this->convertParams($w2dc_listing_fields_widget_params);
	}
