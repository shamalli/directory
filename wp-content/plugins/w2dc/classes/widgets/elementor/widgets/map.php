...
class w2dc_map_elementor_widget extends w2dc_elementor_widget {
	...
	protected function register_controls() {
		...
		$controls = w2dc_elementor_convert_params($w2dc_map_widget_params);
