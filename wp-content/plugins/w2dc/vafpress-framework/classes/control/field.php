 ...
 */
abstract class W2DC_VP_Control_Field implements iFactory
{
	...
	protected function _setup_data()
	{
		...
		$this->add_data('head_info', array(
			...
			'description'             => W2DC_VP_Util_Text::parse_md($this->get_description())
		));
	}
	 ...
	 * @return W2DC_VP_Control_Field Field object
	 */
