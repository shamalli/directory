...
*/
W2DC_VP_AutoLoader::add_namespaces(W2DC_VP_NAMESPACE);
W2DC_VP_AutoLoader::add_directories(W2DC_VP_CLASSES_DIR, W2DC_VP_NAMESPACE);
W2DC_VP_AutoLoader::register();

class W2DC_VP_AutoLoader
{

	/**
	 * Indicates if W2DC_VP_AutoLoader has been registered.
	 * 
	 * @var boolean
	 */
	...
	public static function register()
	{
		...
		{
			spl_autoload_register(array('W2DC_VP_AutoLoader', 'load'));
		}
