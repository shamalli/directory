...
<div class="customEditor">
	...
	<textarea class="vp-input vp-js-wpeditor" id="<?php w2dc_esc_e($name . '_ce'); ?>" data-vp-opt="<?php w2dc_esc_e($opt); ?>" rows="10" cols="50" name="<?php w2dc_esc_e($name); ?>" rows="3"><?php w2dc_esc_e($value); ?></textarea>
</div>
