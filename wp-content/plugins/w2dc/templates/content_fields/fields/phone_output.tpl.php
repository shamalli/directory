...
<div class="w2dc-field w2dc-field-output-block <?php echo $content_field->printClasses($css_classes); ?>">
	...
	<span class="w2dc-field-content w2dc-field-phone-content">
		...
		<meta itemprop="telephone" content="<?php w2dc_esc_e($content_field->value); ?>" />
		<a href="tel:<?php w2dc_esc_e($content_field->value); ?>"><?php echo antispambot($content_field->value); ?></a>
		<?php elseif ($content_field->phone_mode == 'viber'): ?>
		<a href="viber://chat?number=<?php w2dc_esc_e($content_field->value); ?>"><?php echo antispambot($content_field->value); ?></a>
		<?php elseif ($content_field->phone_mode == 'whatsapp'): ?>
		<a href="https://wa.me/<?php w2dc_esc_e($content_field->value); ?>" target="_blank"><?php echo antispambot($content_field->value); ?></a>
		<?php elseif ($content_field->phone_mode == 'telegram'): ?>
		<a href="tg://resolve?domain=<?php w2dc_esc_e($content_field->value); ?>"><?php echo antispambot($content_field->value); ?></a>
		<?php endif; ?>
	</span>
</div>
<?php endif; ?>