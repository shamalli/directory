...
<div class="w2dc-form-group w2dc-field w2dc-field-input-block w2dc-field-input-block-<?php w2dc_esc_e($content_field->id); ?>">
	...
	<div class="w2dc-col-md-10">
		<input type="text" name="w2dc-field-input-<?php w2dc_esc_e($content_field->id); ?>" class="w2dc-field-input-email regular-text w2dc-form-control" value="<?php echo esc_attr($content_field->value); ?>" />
