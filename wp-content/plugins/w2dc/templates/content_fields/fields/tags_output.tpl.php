...
<div class="w2dc-field w2dc-field-output-block <?php echo $content_field->printClasses($css_classes); ?>">
	...
	<span class="w2dc-field-content">
		<?php
		$terms = get_the_terms($listing->post->ID, W2DC_TAGS_TAX);
		foreach ($terms as $term): ?>
			<a href="<?php echo get_term_link($term, W2DC_TAGS_TAX); ?>" rel="tag"><span class="w2dc-label w2dc-label-primary w2dc-tag-label"><?php w2dc_esc_e($term->name); ?>&nbsp;&nbsp;<span class="w2dc-glyphicon w2dc-glyphicon-tag"></span></span></a>
		<?php endforeach; ?>
	</span>
</div>
<?php endif; ?>