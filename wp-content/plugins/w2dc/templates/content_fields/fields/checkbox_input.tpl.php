	...
	<div class="w2dc-col-md-10">
		...
		<div class="w2dc-checkbox w2dc-field-checkbox-input">
			<label>
				...
				<?php endif; ?>
				<input type="checkbox" name="w2dc-field-input-<?php w2dc_esc_e($content_field->id); ?>[]" class="w2dc-field-input-checkbox" value="<?php echo esc_attr($key); ?>" <?php if (in_array($key, $content_field->value)) echo 'checked'; ?> />
				<?php w2dc_esc_e($item); ?>
			</label>
		</div>
		<?php endforeach; ?>
