...
<div class="w2dc-form-group w2dc-field w2dc-field-input-block w2dc-field-input-block-<?php w2dc_esc_e($content_field->id); ?>">
	...
	<div class="w2dc-col-md-10">
		...
		<div class="w2dc-radio">
			<label>
				<input type="radio" name="w2dc-field-input-<?php w2dc_esc_e($content_field->id); ?>" class="w2dc-field-input-radio" value="<?php echo esc_attr($key); ?>" <?php checked($content_field->value, $key, true); ?> />
				<?php w2dc_esc_e($item); ?>
			</label>
		</div>
		<?php endforeach; ?>
