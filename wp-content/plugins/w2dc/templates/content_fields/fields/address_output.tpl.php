...
<div class="w2dc-field w2dc-field-output-block <?php echo $content_field->printClasses($css_classes); ?>">
	...
	<?php foreach ($listing->locations AS $location): ?>
		<address class="w2dc-location" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
			<?php if ($location->map_coords_1 && $location->map_coords_2): ?><span class="w2dc-show-on-map" data-location-id="<?php w2dc_esc_e($location->id); ?>" data-coordinate-lat="<?php w2dc_esc_e($location->map_coords_1); ?>" data-coordinate-lng="<?php w2dc_esc_e($location->map_coords_2); ?>"><?php endif; ?>
