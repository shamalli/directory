...
?>
		<div class="w2dc-content w2dc-location-page">
			<?php do_action('w2dc_location_page_header'); ?>
			...
			<header class="w2dc-page-header">
				...
				<div class="w2dc-term-description w2dc-clearfix"><?php echo term_description($frontend_controller->location->term_id, W2DC_LOCATIONS_TAX); ?></div>
				<?php endif; ?>
			</header>
			<?php endif; ?>
			...
			<?php if ($parent_location = w2dc_isLocation()): ?>
