...
?>
		...
		<div class="w2dc-listing-logo-wrap <?php if ($frontend_controller->args['logo_animation_effect']): ?>w2dc-anim-style<?php else: ?>w2dc-no-anim-style<?php endif; ?>">
			<?php do_action('w2dc_listing_pre_logo_wrap_html', $listing); ?>
			<div class="w2dc-listing-logo <?php if ($listing->level->listings_own_page): ?>w2dc-listings-own-page<?php endif; ?>">
				...
				<?php endif; ?>
					<div class="w2dc-listing-logo-img" style="background-image: url('<?php w2dc_esc_e($img_src); ?>');">
					...
					<div class="w2dc-listing-logo-caption-middle">
						<ul class="w2dc-listing-logo-caption-options">
							<li class="w2dc-listing-logo-caption-option">
								<a href="<?php the_permalink(); ?>" <?php if ($listing->level->nofollow): ?>rel="nofollow"<?php endif; ?> tabindex="-1">
							...
							<li class="w2dc-listing-logo-caption-option w2dc-listing-logo-caption-option-marker w2dc-display-none">
								<a href="javascript:void(0);" class="w2dc-show-on-map" data-location-id="<?php w2dc_esc_e($listing->locations[0]->id); ?>" data-scroll-to-map="1"  tabindex="-1">
							...
							<li class="w2dc-listing-logo-caption-option">
								<a href="<?php the_permalink(); ?>#comments-tab" <?php if ($listing->level->nofollow): ?>rel="nofollow"<?php endif; ?> tabindex="-1">
							...
							<li class="w2dc-listing-logo-caption-option">
								<a href="<?php the_permalink(); ?>#images" <?php if ($listing->level->nofollow): ?>rel="nofollow"<?php endif; ?> tabindex="-1">
							...
							<li class="w2dc-listing-logo-caption-option">
								<a href="<?php the_permalink(); ?>#videos-tab" <?php if ($listing->level->nofollow): ?>rel="nofollow"<?php endif; ?> tabindex="-1">
							...
							<li class="w2dc-listing-logo-caption-option">
								<a href="<?php the_permalink(); ?>#contact-tab" <?php if ($listing->level->nofollow): ?>rel="nofollow"<?php endif; ?> tabindex="-1">
		...
		<div class="w2dc-remove-from-favourites-list w2dc-fa w2dc-fa-close" listingid="<?php the_ID(); ?>" title="<?php echo esc_attr__('Remove from favourites list', 'w2dc'); ?>"></div>
		<?php endif; ?>
