...
?>
		<div class="w2dc-content w2dc-controller w2dc-listings-carousel-wrapper" id="w2dc-controller-<?php w2dc_esc_e($frontend_controller->hash); ?>" data-controller-hash="<?php w2dc_esc_e($frontend_controller->hash); ?>">
			<style type="text/css">
				#w2dc-controller-<?php w2dc_esc_e($frontend_controller->hash); ?> article.w2dc-listing {
					width: <?php w2dc_esc_e($frontend_controller->args['carousel_slide_width']); ?>px;
				}
				#w2dc-controller-<?php w2dc_esc_e($frontend_controller->hash); ?>.w2dc-listings-carousel-wrapper {
				...
				#w2dc-controller-<?php w2dc_esc_e($frontend_controller->hash); ?> article.w2dc-listing .w2dc-listing-logo-img-wrap {
					height: <?php w2dc_esc_e($frontend_controller->args['carousel_slide_height']); ?>px;
				}
			</style>
			<script>
