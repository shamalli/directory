	<form action="" method="POST" role="form" class="w2dc-dashboard-profile">
		...
		<div class="w2dc-form-group">
			...
			<p>
				<label for="email"><?php _e('Website', 'W2DC'); ?></label>
			...
			<?php endif; ?>
			 <div>
			 	...
			 	<div class="user-pass1-wrap">
					<button type="button" class="button w2dc-btn w2dc-btn-primary wp-generate-pw hide-if-no-js"><?php _e('Generate Password', 'W2DC'); ?></button>
