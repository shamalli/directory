...
<div class="w2dc-content">
	...
	<h2><?php echo sprintf(__('Edit %s "%s"', 'W2DC'), $listing->directory->single, $listing->title()); ?></h2>
			...
			<form action="" method="POST" enctype="multipart/form-data">
				...
				<div class="w2dc-submit-section w2dc-submit-section-title">
					...
					<div class="w2dc-submit-section-inside">
						<input type="text" name="post_title" style="width: 100%" class="w2dc-form-control" value="<?php if ($listing->post->post_title != __('Auto Draft')) echo esc_attr($listing->post->post_title); ?>" />
					</div>
				</div>
